  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <button class="flex mx-auto text-white bg-black border-white border-2 py-2 px-8 focus:outline-none hover:bg-white hover:text-black rounded text-lg">Send Message</button>
        </div>
        </div>
        </div>
        </div>
